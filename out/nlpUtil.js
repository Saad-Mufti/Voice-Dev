...
class NLPUtility {
    ...
    vcsTrain() {
        return __awaiter(this, void 0, void 0, function* () {
            const container = yield containerBootstrap();
            container.use(Nlp);
            ...
            yield manager.train();
            // manager.save()
            let ex = yield manager.process('en', 'commit my code');
            // debugger
    ...
    classifier() {
        return this.vcsTrain().then((res) => __awaiter(this, void 0, void 0, function* () {
            return res;
        }));
    }
